...
namespace DCAPST
{
    ...
    public class AssimilationCCM : Assimilation
    {
        ...
        protected override AssimilationFunction GetAjFunction(AssimilationPathway pathway)
        {
            ...
            x[0] = (1 - parameters.MesophyllElectronTransportFraction) * parameters.ATPProductionElectronTransportFactor * pathway.Leaf.J / 3.0;
            x[1] = 7.0 / 3.0 * pathway.Leaf.Gamma;
            x[2] = 0.0;
            x[3] = 0.0;
            x[4] = parameters.MesophyllElectronTransportFraction * parameters.ATPProductionElectronTransportFactor * pathway.Leaf.J / parameters.ExtraATPCost;
            x[5] = 0.0;
            x[6] = pathway.ChloroplasticCO2 * (1 - parameters.MesophyllElectronTransportFraction) * parameters.ATPProductionElectronTransportFactor * pathway.Leaf.J / (3 * pathway.ChloroplasticCO2 + 7 * pathway.Leaf.Gamma * pathway.ChloroplasticO2);
            x[7] = 1.0;
            x[8] = 1.0;

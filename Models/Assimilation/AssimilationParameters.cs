...
namespace DCAPST
{
    public abstract class AssimilationParameters
    {
        ...
        public AssimilationCalculator GetCalculator()
        {
            if (assimilation.Type == AssimilationType.Ac1) return GetAc1Calculator();
            else if (assimilation.Type == AssimilationType.Ac2) return GetAc2Calculator();
            else return GetAjCalculator();
        }
